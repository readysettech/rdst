    ...
    <div data-tour-anchor="chart" className={panel('p-4 pb-2')}>
      <TooltipProvider delayDuration={150}>
        <div className="mb-1 flex flex-wrap items-baseline gap-x-5 gap-y-2">
          ...
          <div
            className="ml-auto inline-flex overflow-hidden rounded-lg border border-border-layout-1 text-label-small"
            role="group"
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                >
                  {failed
                    ? 'failed'
                    : `${c.detail ?? 'Starting...'}${elapsedS >= 3 ? ` · ${elapsedS}s` : ''}`}
                </Text>
              </div>
            </div>
          )
          ...
          <div className="flex h-7 items-center">
            {hasComparison ? (
              <Text
                ...
                className="font-medium tabular-nums text-content-layout-2"
              >
