...
/**
 * The dialog under an exhausted trial: the one requirement shape the rerender
 * tests below share, so each frame only re-states its `isOpen`.
 */
function exhaustedDialog(onClose: () => void, isOpen = true) {
  return (
    <EnvSecretsDialog
      isOpen={isOpen}
      onClose={onClose}
