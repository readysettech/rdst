  ...
  const gateError =
    gate.reason === 'invalid'
      ...
      : gate.reason === 'exhausted'
        ? 'Your previous hosted access is no longer active. Sign in to Readyset or add an Anthropic key.'
        : null
  ...
  return (
    <GateFrame>
      <div className="mx-auto w-full max-w-5xl">
        <VStack className="mx-auto mb-8 max-w-2xl items-center gap-3 text-center">
          ...
          <Text level="body-medium" className="max-w-xl text-content-layout-2">
            Sign up for free Readyset-hosted inference, or connect your own
            Anthropic key. You can change this later in Settings.
          </Text>
        </VStack>
        ...
        <div className="grid gap-5 tablet:grid-cols-2">
          <Card className="flex min-h-96 flex-col overflow-hidden border-border-primary-soft bg-surface-primary-soft/20 shadow-elevation-1">
            <Card.Header className="border-border-primary-soft/60">
              ...
              <Card.Title className="mt-3">Readyset-hosted AI</Card.Title>
              <Card.Description>
                Create a Readyset account or sign in for free hosted inference.
                Each account has a usage limit.
              </Card.Description>
            </Card.Header>
          ...
          <Card className="flex min-h-96 flex-col overflow-hidden">
            <Card.Header>
              ...
              <Card.Description>
                ...
                Claude Sonnet model and bills inference to your key.
              </Card.Description>
            </Card.Header>
            <Card.Content className="flex-1 space-y-3">
      ...
      <EnvSecretsDialog
        ...
        trialActionLabel="Use free Readyset-hosted AI"
        onSuccess={refresh}
      />
    </GateFrame>
  )
