    ...
    <Modal open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <ModalContentContainer open={isOpen}>
        <TaskDialogContent
          ...
          description="Define the business meaning and SQL behind this metric."
          ...
          footer={
            <div className="flex justify-end gap-3">
              ...
              <Button
                variant="rising"
                label={isEditing ? 'Save changes' : 'Add metric'}
                onClick={handleSave}
                loading={isLoading}
        ...
        >
          ...
          <div>
            <Text level="label-small" className="text-content-layout-2 mb-1">
              Metric Name <span className="text-content-negative-soft">*</span>
            </Text>
            <BaseInputText
              value={name}
          ...
          <div>
            <Text level="label-small" className="text-content-layout-2 mb-1">
              SQL Expression{' '}
              <span className="text-content-negative-soft">*</span>
            </Text>
            <BaseInputTextarea
              value={sql}
