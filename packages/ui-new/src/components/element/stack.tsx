...
export const HStack = ({ className, ...props }: ComponentProps<"div">) => (
  <div className={stackStyles({ variant: "hstack", class: className })} {...props} />
);

export const VStack = ({ className, ...props }: ComponentProps<"div">) => (
  <div className={stackStyles({ variant: "vstack", class: className })} {...props} />
);

export const Stack = ({ className, ...props }: ComponentProps<"div">) => (
  <div className={stackStyles({ variant: "stack", class: className })} {...props} />
);
