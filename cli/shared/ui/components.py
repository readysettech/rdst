...
Usage:
    from shared.ui.components import QueryPanel, DataTable, MessagePanel
...
def MarkdownContent(content: str):
    ...
    Usage:
        from shared.ui import MarkdownContent, get_console
        console = get_console()
...
class SimpleTree:
    ...
    Usage:
        from shared.ui import SimpleTree, get_console
...
class Rule:
    ...
    Usage:
        from shared.ui import Rule, get_console
        console = get_console()
...
class KeyboardShortcuts:
    ...
    Usage:
        from shared.ui import KeyboardShortcuts, get_console
