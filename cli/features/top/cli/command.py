...
if TYPE_CHECKING:
    from shared.db_config_check import TargetConfig
...
from ..models import TopInput, TopOptions
...
class TopCommand:
    ...
    def _run_realtime_with_service(
        ...
        def keypress_thread():
            ...
            try:
                ...
                # Non-TTY stdin (e.g., CI, pytest) — termios.error, OSError, etc.
                pass
    ...
    def _analyze_selected_query_from_top(self, selected_query, target_name: str):
        ...
        try:
            ...
            from shared.query_registry import normalize_sql
    ...
    def _save_queries_to_registry_from_top(
        ...
        try:
            from shared.query_registry import QueryRegistry
            from shared.query_registry import generate_query_name
        except ImportError:
            self._console.print(
