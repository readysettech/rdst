...
from shared.ui import StyleTokens, get_console, NextSteps, NoticePanel
...
from .monitor import ActivityQueryCollector, QueryTracker
from .display import TopDisplay, format_query_for_save
...
def _check_and_warn_db_limit(connection, db_engine: str, console) -> None:
    ...
    try:
        from shared.db_connection import (
            format_db_limit_command,
            query_db_query_size_limit,
        )
...
def run_realtime_monitor(
    ...
    Args:
        ...
        console: Console instance (optional, uses the shared UI default)
