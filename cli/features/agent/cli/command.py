...
from shared.ui import DataTableBase, Prompt, StyleTokens, get_console
...
"""
    ...
    def _show(self, name: str | None = None, **kwargs) -> RdstResult:
        ...
        try:
            ...
            if agent.guard:
                ...
                # Show guard details
                try:
                    from features.guard import GuardManager
    ...
    def _chat(self, name: str | None = None, timeout: int = 600, **kwargs) -> RdstResult:
        ...
        try:
            ...
            from features.agent.chat_tools import format_tool_result_for_display
            ...
            while True:
                ...
                if response.text:
                    from shared.ui import MarkdownContent
                    console.print()
    ...
    def _slack(self, name: str | None = None, **kwargs) -> RdstResult:
        ...
        try:
            ...
            from features.slack.config import load_credentials
