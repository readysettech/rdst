...
from lib.fleet.models import AuditMetrics, CacheOpportunityScore, SizingAssessment, SizingVerdict
...
def compute_sizing_verdict(
    ...
    if instance_class:
        try:
            from lib.fleet.pricing_data import monthly_cost, suggest_downsize
